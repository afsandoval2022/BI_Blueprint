-- Agregar columnas para los scores RFM
ALTER TABLE RFM ADD COLUMN R_score INTEGER;
ALTER TABLE RFM ADD COLUMN F_score INTEGER;
ALTER TABLE RFM ADD COLUMN M_score INTEGER;

-- Agregar columnas para los labels RFM
ALTER TABLE RFM ADD COLUMN R_label TEXT;
ALTER TABLE RFM ADD COLUMN F_label TEXT;
ALTER TABLE RFM ADD COLUMN M_label TEXT;
